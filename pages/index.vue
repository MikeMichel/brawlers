...
<template>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    ...
    <div class="card-body">
      <h2 class="card-title">{{ brawler.name }}
        <div class="badge badge-secondary">{{brawler.rarity.name}}</div>
        <div class="badge badge-primary">{{brawler.class.name}}</div>
      </h2>
